...
export const PATH_MASK_VERSION = 'e2-9-r5-path-mask-3.3.0'
export const PACKET_SCHEMA_VERSION = 'e2.9-r5-adjudication-packet-3.3.0'
export const COMMITMENT_VERSION = 'e2-9-r5-assignment-commitment-1.0.0'
export const CHRONOLOGY_VERSION = 'e2-9-r5-adjudication-chronology-1.0.0'
...
export function syntheticAssignmentBalance(revealSecret, count = 100) {
  const assignments = Array.from({ length: count }, (_, index) => deriveSideAssignment({ revealSecret, runId: 'synthetic-r5', caseId: `synthetic-${index + 1}` }).X)
