...
export const E2_9_R5_HASH_CONTRACT_VERSION = 'e2-9-r5-bundle-hash-3.3.0'
export const E2_9_R5_BUNDLE_SEPARATOR = '\n--E2-9-R5-BUNDLE-ENTRY--\n'
...
export async function hashBundle(root, inputFiles) {
  ...
  const framed = entries.map((entry) => entry.frame).join(E2_9_R5_BUNDLE_SEPARATOR)
  return {
    contractVersion: E2_9_R5_HASH_CONTRACT_VERSION,
    separator: E2_9_R5_BUNDLE_SEPARATOR,
    inputFiles: files,
