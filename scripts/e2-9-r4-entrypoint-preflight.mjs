...
export const R4_POST_GENERATION_ENTRYPOINTS = Object.freeze([
  'scripts/prepare-e2-9-r4-packet-preview.mjs',
  'scripts/finalize-e2-9-r4-packet.mjs',
  'scripts/reveal-e2-9-r4-adjudication.mjs',
  'scripts/score-e2-9-r4.mjs',
  'scripts/evaluate-e2-9-r4-gate.mjs',
])
...
export async function verifyEntrypointImportContracts({ root = process.cwd(), entryFiles = R4_POST_GENERATION_ENTRYPOINTS } = {}) {
  const verified = []
