...
export const E2_9_R4_HASH_CONTRACT_VERSION = 'e2-9-r4-bundle-hash-3.2.0'
export const E2_9_R4_BUNDLE_SEPARATOR = '\n--E2-9-R4-BUNDLE-ENTRY--\n'
...
export async function hashBundle(root, inputFiles) {
  ...
  const framed = entries.map((entry) => entry.frame).join(E2_9_R4_BUNDLE_SEPARATOR)
  return {
    contractVersion: E2_9_R4_HASH_CONTRACT_VERSION,
    separator: E2_9_R4_BUNDLE_SEPARATOR,
    inputFiles: files,
