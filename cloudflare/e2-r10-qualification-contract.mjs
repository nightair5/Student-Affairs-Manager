export const E2_R10_PROTOCOL_VERSION = 'e2-9-r10-facts-first-protocol-1.1.4'
export const E2_R10_QUALIFICATION_VERSION = 'e2-9-r10-zero-model-qualification-1.1.4'
export const E2_R10_CONTRACT_SCHEMA_VERSION = 'e2.9-r10-qualification-contract-1.2.4'
...
export const E2_R10_REQUIRED_COMPONENT_VERSIONS = Object.freeze({
  ...
  qualificationWorker: 'e2-r10-qualification-worker-1.1.4',
  qualificationLedger: 'e2-r10-qualification-ledger-1.1.4',
