...
const staticPaths = new Set(['/', '/index.html', '/boot.js', '/browser.js', '/browser.css', '/recorded/Q01-06.json', '/recorded/Q07-06.json', '/recorded/R11-07.json', '/recorded/R12-07.json', '/recorded/U11-09.json', '/recorded/V02-09.json'])
const headers = {
...
export default {
  async fetch(request, env) {
    ...
    if(url.pathname==='/api/status')return Response.json({experiment:'real-input-https-preview-1',modelCallsEnabled:false,
      storage:'browser-only-new-origin',records:['Q01-06','Q07-06','R11-07','R12-07','U11-09','V02-09'],candidateAdopted:false},{headers})
