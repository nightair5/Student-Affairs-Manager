export const E2_R3_TRANSPORT_POLICY_VERSION = 'e2-9-r3-transport-policy-3.1.0'
...
export async function classifyR3Failure(error, execution, expectedModel) {
  ...
  return {
    schemaVersion: E2_R3_TRANSPORT_POLICY_VERSION,
    classification,
