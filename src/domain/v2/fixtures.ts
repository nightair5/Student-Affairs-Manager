...
export function createGoldenWorkspaceV8(): WorkspaceV8 {
  ...
  const timePoints: WorkspaceV8['timePoints'] = [
    { id: 'time-1', projectId: 'project-competition', milestoneId: 'milestone-1', taskId: 'task-1', materialId: null, eventId: null, relatedTaskIds: ['task-1'], relatedMaterialIds: [], type: 'registration_deadline', rawText: '8月10日18:00前报名', normalizedValue: '2026-08-10T18:00', timezone: 'Asia/Shanghai', isAllDay: false, precision: 'exact', needsConfirmation: false, createdAt: NOW, updatedAt: NOW },
    { id: 'time-2', projectId: 'project-competition', milestoneId: 'milestone-2', taskId: 'task-2', materialId: null, eventId: null, relatedTaskIds: ['task-2'], relatedMaterialIds: [], type: 'task_deadline', rawText: '8月20日完成作品', normalizedValue: '2026-08-20', timezone: null, isAllDay: true, precision: 'date_only', needsConfirmation: false, createdAt: NOW, updatedAt: NOW },
    { id: 'time-3', projectId: 'project-competition', milestoneId: 'milestone-3', taskId: 'task-3', materialId: null, eventId: null, relatedTaskIds: ['task-3'], relatedMaterialIds: ['material-3'], type: 'submission_deadline', rawText: '8月25日17:00提交', normalizedValue: '2026-08-25T17:00', timezone: 'Asia/Shanghai', isAllDay: false, precision: 'exact', needsConfirmation: false, createdAt: NOW, updatedAt: NOW },
    { id: 'time-4', projectId: 'project-competition', milestoneId: 'milestone-4', taskId: 'task-4', materialId: null, eventId: null, relatedTaskIds: ['task-4'], relatedMaterialIds: [], type: 'planned_start', rawText: '答辩前一周开始准备', normalizedValue: null, timezone: null, isAllDay: false, precision: 'relative', needsConfirmation: true, createdAt: NOW, updatedAt: NOW },
    { id: 'time-5', projectId: 'project-competition', milestoneId: 'milestone-4', taskId: null, materialId: null, eventId: 'event-defense', relatedTaskIds: [], relatedMaterialIds: [], type: 'event_start', rawText: '9月2日14:00答辩', normalizedValue: '2026-09-02T14:00', timezone: 'Asia/Shanghai', isAllDay: false, precision: 'exact', needsConfirmation: false, createdAt: NOW, updatedAt: NOW },
  ]
  ...
  return {
    ...
    extractionDrafts: [{ id: 'draft-1', recognitionRunId: 'recognition-run-1', status: 'confirmed', result: null, commitOperationIds: [], acceptedEntityTempIds: [], rejectedEntityTempIds: [], createdAt: NOW, updatedAt: NOW }],
