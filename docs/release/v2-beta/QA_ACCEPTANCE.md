...
| 2026-08-31 04:15:24（RC.4，Production） | 200 HTML；Deployment `8bad8cc4…` / Version `1d6dc48e…` 未变 | 200；configured true；`deepseek-v4-flash`；仅检查状态，未调用模型 | 六条路径均为 JSON 404 | 200 HTML；status 200/configured true；Deployment `b353533d…` / Version `d245a1dc…` 未变 | 六条路径均为 JSON 404 | Production 起点后约 3 小时 17 分 27 秒无失败窗口或部署漂移；Preview 仍隔离可用；未发送正文、未调用付费模型 |
| 2026-08-31 11:11:02（RC.4，Production） | 200 HTML；Deployment `8bad8cc4…` / Version `1d6dc48e…` 未变 | 200；configured true；`deepseek-v4-flash`；仅检查状态，未调用模型 | 六条路径均为 JSON 404 | 200 HTML；status 200/configured true；Deployment `b353533d…` / Version `d245a1dc…` 未变 | 六条路径均为 JSON 404 | Production 起点后约 10 小时 13 分 05 秒无失败窗口或部署漂移；Preview 仍隔离可用；未发送正文、未调用付费模型 |
| 2026-08-31 17:11:25（RC.4，Production） | 200 HTML；Deployment `8bad8cc4…` / Version `1d6dc48e…` 未变 | 200；configured true；`deepseek-v4-flash`；仅检查状态，未调用模型 | 六条路径均为 JSON 404 | 200 HTML；status 200/configured true；首次 Cloudflare control-plane 查询超时，重试确认 Deployment `b353533d…` / Version `d245a1dc…` 未变 | 六条路径均为 JSON 404 | Production 起点后约 16 小时 13 分 29 秒无产品失败窗口或部署漂移；一次只读控制面查询超时未影响站点且重试成功；Preview 仍隔离可用；未发送正文、未调用付费模型 |
| 2026-08-31 23:11:31（RC.4，Production） | 200 HTML；Deployment `8bad8cc4…` / Version `1d6dc48e…` 未变 | 200；configured true；`deepseek-v4-flash`；仅检查状态，未调用模型 | 六条路径均为 JSON 404 | 200 HTML；status 200/configured true；Deployment `b353533d…` / Version `d245a1dc…` 未变 | 六条路径均为 JSON 404 | Production 起点后约 22 小时 13 分 34 秒无产品失败窗口或部署漂移；Preview 仍隔离可用；未发送正文、未调用付费模型 |
| 2026-09-01 18:03:00（RC.4，Production） | 200 HTML；Deployment `8bad8cc4…` / Version `1d6dc48e…` 未变 | 200；configured true；`deepseek-v4-flash`；仅检查状态，未调用模型 | 六条路径均为 JSON 404 | 200 HTML；status 200/configured true；Deployment `b353533d…` / Version `d245a1dc…` 未变 | 六条路径均为 JSON 404 | Production 起点后约 41 小时 05 分 04 秒无产品失败窗口或部署漂移；Preview 仍隔离可用；未发送正文、未调用付费模型 |
| 2026-09-02 00:04:05（RC.4，Production） | 200 HTML；Deployment `8bad8cc4…` / Version `1d6dc48e…` 未变 | 200；configured true；`deepseek-v4-flash`；仅检查状态，未调用模型 | 六条路径均为 JSON 404 | 200 HTML；status 200/configured true；Deployment `b353533d…` / Version `d245a1dc…` 未变 | 六条路径均为 JSON 404 | Production 起点后约 47 小时 06 分 08 秒无产品失败窗口或部署漂移；Preview 控制面首次只读查询失败，重试确认版本未变，站点全程可用；未发送正文、未调用付费模型 |
