...
自动证据覆盖 Key 服务端化、Origin、Content-Type、请求体大小、Prompt injection、SSRF 与每跳 redirect 复核、安全错误、实验 route isolation 和 Secret scan。Preview bundle/network、Export 与文件上传仍需 A–J 人工复核，当前判定 PARTIAL。
...
P2/P3 在 48 小时稳定期后处理，不得在稳定期增加功能。分支建议：
